...
public class Person {
    ...
    public Person(String name, int age, int sex, double income, int hasChild, int hasSiblingRegister, int hasParent, int deduction,int numSib) {
        this.name = name;
        this.age = age;
        this.sex = sex;
        this.income = income;
    ...
    public void setNumSib(int numSib) {
        this.numSib = numSib;
    }
